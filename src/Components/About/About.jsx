    ...
    className="mt-10 md:mt-25" id="About">
      ...
      <div className="mb-5 md:mb-17.5">
        <h1 className="font-Instrument text-[40px] leading-12.5 md:text-[60.8px] md:leading-[70.8px] text-white md:w-88.75">
          ...
          <span className="text-sky-500 italic">intent.</span>
        </h1>
      </div>
      <div className="md:flex justify-between">
        <div className="md:w-[40%]">
          <p className="text-white opacity-65 mb-7.5  font-Manrope font-light">
          ...
          <p className="text-white opacity-65  font-Manrope font-light">
